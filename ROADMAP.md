...
2. **UX/Interactions** restantes : la plupart des sous-items (redirection single-trip, barre sticky, max-width des champs, préremplissages, saisie clavier calendrier, titre Vol/Train, ville de retour d'un vol) sont traités, voir "✅ Déjà fait". Restent, faute d'être assez cadrés pour être tranchés sans nouvelle discussion (voir "🔧 À faire") : gap PC de la bascule Activités/Réservations/Notes (non reproduit avec l'implémentation actuelle, à reconfirmer), contour des jours de l'onglet Général, taille d'un bouton non identifié précisément.
...
- Je ne me sert pa pour l'instant de deadline
- Pour toutes les dialoges, les uniformiser , mettre tout les titres en gras, toutes les croix au même endroit, supprimer les croix devant les potentiels zones de saisi car le bouton annuler est fait pour ça en dessous, supprimer le bouton "Ok" à droite des zones de saisie car le bouton ok en bas est fait pour ça. 
...
- Agrandir taille du bouton (référent précis pas identifié — préciser quel bouton pour reprendre ce point)
