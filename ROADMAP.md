...
- Édition d'activité 100% par composants dédiés mobile : notes et prix/devise sont les deux derniers champs édités inline (tout le reste — type, résa, horaires... — a déjà son composant mobile dédié), il manque un drawer plein écran pour chacun. Remplace l'ancienne piste "replier la carte pendant l'édition" (retirée, voir "Déjà fait" — décision : plutôt régler le partage d'espace écran via ces drawers que via un collapse de la carte). Conception UX à faire.
