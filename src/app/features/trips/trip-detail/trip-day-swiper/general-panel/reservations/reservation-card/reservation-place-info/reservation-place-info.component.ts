 ...
 */
@Component({
  selector: 'app-reservation-place-info',
  standalone: true,
  imports: [CommonModule, TagComponent, PanelComponent, DividerComponent],
  templateUrl: './reservation-place-info.component.html',
  styleUrl: './reservation-place-info.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ReservationPlaceInfoComponent {
