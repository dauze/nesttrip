...
import { LogementFieldsComponent } from '../../logistic-form/logement-fields/logement-fields.component';
...
@Component({
  ...
  imports: [
    ...
    LogementFieldsComponent, FlightFieldsComponent, CarRentalFieldsComponent, GenericFieldsComponent,
...
export class LogisticDetailsComponent {
   ...
   * (voir LogisticsCreationService) : ouvre successivement Type → Résa →
