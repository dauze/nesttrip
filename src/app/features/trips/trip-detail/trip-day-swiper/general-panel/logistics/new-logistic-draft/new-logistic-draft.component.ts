 ...
 * LogisticHeaderComponent : le titre d'une réservation n'est jamais lié à
 ...
 */
@Component({
  selector: 'app-new-logistic-draft',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './new-logistic-draft.component.html',
  styleUrl: './new-logistic-draft.component.scss',
})
export class NewLogisticDraftComponent {
